...
test_01_TestDataSeriesExist = data_series_match_reference.build(
    Options(
...
test_03_TestDataSeriesExist = data_series_match_reference.build(
    Options(
        ref_module=REF_MODULE,
        sub_module=SUB_MODULE,
        entries=("G24", "G30"),
...
test_04_TestDataSeriesExist = data_series_match_reference.build(
    Options(
        ref_module=REF_MODULE,
        sub_module=SUB_MODULE,
        entries=("H24", "H30"),
