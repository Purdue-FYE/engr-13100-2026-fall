...
The engineers want to add an insulative coating which costs $32 per square centimeter.
...
#### Question 1
(a) Which two 3-dimensional shapes will you use to approximate the thermometer’s surface area?
...
(c) Does your model over estimate or under estimate the true surface area of the thermometer? Explain your reasoning.
