...
### Terminal (a)
    ...
    Enter the fourth number (1-50): 8
    You entered: 1, 13, 9, 8
    You entered an unlucky number!
    You entered the unluckiest number!
    Your score is: 11
    ...
    Your numbers are mid. Low score
    Your score is: 5
