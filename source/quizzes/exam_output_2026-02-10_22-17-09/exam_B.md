...
<img src="chart-formatting-1-data.png" alt="Two column data set" style="width:80%; display:block; margin:auto;">

Your teammate plotted the data in Excel, shown below.

<!-- ![Preliminary chart](chart-formatting-1-chart.png) -->
<img src="chart-formatting-1-chart.png" alt="Preliminary chart" style="width:80%; display:block; margin:auto;">
