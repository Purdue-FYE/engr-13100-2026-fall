...
### Hello World
Python executes code line by line. The simplest program prints output to the screen.
...
```{admonition} Tip
:class: tip
- Download and open the `ENGR131_Python_Template.py </Part_04_Python/ENGR131_Python_Template.py>
